...
export const HairExtensionsSection = (): JSX.Element => {
  return (
    <section className="flex flex-col w-full items-start gap-6 sm:gap-8 lg:gap-10 pt-12 sm:pt-16 lg:pt-[100px] pb-12 sm:pb-14 lg:pb-16 px-4 sm:px-8 lg:px-12 bg-backgroundbackground-2">
