...
export function LifeAfterJapa({ articles }: LifeAfterJapaProps) {
  ...
  return (
    <section className="py-12 bg-gradient-to-br from-purple-50 to-pink-50 dark:from-gray-900 dark:to-purple-900/20">
      <div className="container mx-auto px-4">
        <div className="flex items-center justify-between mb-8">
          <div>
            ...
            <p className="text-gray-600 dark:text-gray-400">
              Stories, experiences, and insights about life abroad
            </p>
          </div>
        </div>
        ...
        <div className="bg-gradient-to-r from-purple-600 to-pink-600 text-white p-6 rounded-lg mb-8">
          <p className="text-lg font-medium">
            Discover real stories and practical advice from those who have successfully relocated abroad
          </p>
        </div>
        ...
        {articles.length > 3 && (
          <div className="text-center">
            <button
              ...
              className="inline-flex items-center gap-2 bg-purple-600 hover:bg-purple-700 text-white font-semibold py-3 px-8 rounded-lg transition-colors"
            >
              {showAll ? (
                <>
                ...
                <>
                  ...
                  View All Life After Japa Stories
                </>
              )}
            </button>
